...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { IRA: @aluno.IRA, matricula: @aluno.matricula, nome: @aluno.nome, semestre: @aluno.semestre }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { IRA: @aluno.IRA, matricula: @aluno.matricula, nome: @aluno.nome, semestre: @aluno.semestre }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
